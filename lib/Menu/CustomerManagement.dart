...
import 'package:maxmybill/Menu/Menu.dart' hide kWhite, kPrimaryColor, kErrorColor, kGoogleGreen, kOrange, kGrey200, kGrey300, kGrey400, kGreyBg, kBlack87, kBlack54, kGrey100;
          ...
          child: Column(
            ...
            children: [
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  const Text('Delete blocked', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: kBlack87)),
                  GestureDetector(onTap: () => Navigator.pop(context), child: const HeroIcon(HeroIcons.xMark, size: 24, color: kBlack54)),
                ],
              ),
              const SizedBox(height: 24),
              const HeroIcon(HeroIcons.exclamationTriangle, color: kOrange, size: 48),
              const SizedBox(height: 16),
              Text(
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: const Text('OK', style: TextStyle(color: kWhite, fontWeight: FontWeight.w600)),
                ),
              ),
            ],
          ),
