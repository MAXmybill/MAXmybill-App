...
import 'package:maxmybill/Settings/TaxSettings.dart' as TaxSettingsNew;
    ...
    try {
      ...
      if (store != null && store.exists) {
        ...
        setState(() {
          ...
          _ownerCtrl.text = data['ownerName'] ?? '';
          _logoUrl = data['logoUrl'];
          // Check premium status (fail closed): paid plan is valid only with a non-expired date.
...
class _PrinterSetupPageState extends State<PrinterSetupPage> {
  ...
  Future<void> _setPrinterWidth(String width) async {
    ...
    await prefs.setString('thermal_page_size', width);
