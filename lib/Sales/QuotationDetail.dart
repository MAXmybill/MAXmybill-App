          ...
          child: Column(
            ...
            children: [
              ...
              ...items.map((item) {
                ...
                final totalWithTax =
                    (item['totalWithTax'] ?? item['total'] ?? 0.0).toDouble();
                return Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              '$qty  x  $currencySymbol${price.toStringAsFixed(2)}',
                              style: const TextStyle(
                                fontSize: 12,
                      ...
                      Text(
                        '$currencySymbol${totalWithTax.toStringAsFixed(2)}',
                        style: const TextStyle(
                          fontWeight: FontWeight.w800,
                          fontSize: 14,
                          color: kPrimaryColor,
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    _buildPriceRow(
                      'Subtotal',
                      (quotationData['subtotal'] ?? 0.0).toDouble(),
                    ),
                    _buildPriceRow(
                      'Discount',
                      -(quotationData['discount'] ?? 0.0).toDouble(),
    ...
    return Row(
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            color: active ? kPrimaryColor.withOpacity(0.1) : kGreyBg,
            borderRadius: BorderRadius.circular(20),
          ),
          child: Text(
            active ? 'Open' : 'Billed',
            style: TextStyle(
              fontSize: 10,
              fontWeight: FontWeight.w800,
              color: active ? kPrimaryColor : kBlack54,
            ),
          ),
        ),
      ],
        ...
        children: [
          Text(
            ...
            style: TextStyle(
              ...
              color: isBold ? kBlack87 : kBlack54,
            ),
          ),
          Text(
            ...
            style: TextStyle(
              ...
              fontWeight: FontWeight.w800,
              color: valueColor ?? (isBold ? kPrimaryColor : kBlack87),
            ),
          ),
        ],
      ),
  ...
  void _confirmDelete(BuildContext context) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: const Text(
          'Delete Quotation',
          style: TextStyle(fontWeight: FontWeight.w900, color: kBlack87),
        ),
        content: const Text(
