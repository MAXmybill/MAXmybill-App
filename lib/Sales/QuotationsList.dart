...
import 'package:maxmybill/Sales/QuotationDetail.dart';
...
class _QuotationsListPageState extends State<QuotationsListPage> {
  ...
  List<QueryDocumentSnapshot> _processList(List<QueryDocumentSnapshot> docs) {
    var filtered = docs.where((doc) {
      ...
      final customerName = (data['customerName'] ?? '')
          .toString()
          .toLowerCase();
      final quotationNumber = (data['quotationNumber'] ?? '')
          .toString()
          .toLowerCase();
      return customerName.contains(_searchQuery) ||
          quotationNumber.contains(_searchQuery);
    }).toList();
        ...
        appBar: AppBar(
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.vertical(
              bottom: Radius.circular(R.sp(context, 24)),
            ),
          ),
  ...
  void _showSortMenu() {
    showModalBottomSheet(
      ...
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.vertical(
          top: Radius.circular(R.sp(context, 20)),
        ),
      ),
  ...
  Widget _buildEmpty() => Center(
    child: Column(
      ...
      children: [
        ...
        SizedBox(height: R.sp(context, 16)),
        Text(
          context.tr('no_quotations_found'),
          style: TextStyle(
            color: kBlack54,
            fontWeight: FontWeight.w600,
            fontSize: R.sp(context, 14),
