...
import 'package:maxmybill/Sales/components/sale_app_bar.dart';
import 'package:maxmybill/Sales/components/common_widgets.dart';
import 'package:maxmybill/Sales/saleall.dart';
...
class NewQuotationPage extends StatefulWidget {
  ...
  final bool
  isEditMode; // When true, bottom bar shows "Use Items" instead of Quotation
...
class _NewQuotationPageState extends State<NewQuotationPage>
  ...
  void initState() {
    ...
    if (widget.initialQuotationData != null) {
      ...
      final items =
          widget.initialQuotationData!['items'] as List<dynamic>? ?? [];
                                      ...
                                      onTap: () {
                                        ...
                                        if (stockEnabled &&
                                          ...
                                          ScaffoldMessenger.of(
                                            ...
                                            SnackBar(
                                              content: Text(
                                                'Maximum stock available: ${availableStock.toInt()}',
                                              ),
                                ...
                                : () {
                                    ...
                                    if (stockEnabled &&
                                      ...
                                      ScaffoldMessenger.of(
                                        ...
                                        SnackBar(
                                          content: Text(
                                            'Cannot save: Only ${availableStock.toInt()} available in stock',
                                          ),
                                          backgroundColor: kErrorColor,
                                    ...
                                    if (newQty > 0) {
                                      ...
                                      nextItems[idx] = CartItem(
                                        productId: item.productId,
                                        name: newName,
                                        price: newPrice,
                                        quantity: newQty,
                                        taxes: item.taxes.isNotEmpty
                                            ? item.taxes
                                            : null,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Are you sure you want to clear this quotation? All line items will be removed.',
                textAlign: TextAlign.center,
                style: TextStyle(
                  color: kBlack54,
      ...
      builder: (context, value, _) {
        ...
        return TextField(
          ...
          style: TextStyle(
            ...
            color: enabled ? kBlack87 : Colors.black45,
          ),
          decoration: InputDecoration(
            hintText: hint,
            filled: true,
  ...
  Widget build(BuildContext context) {
    ...
    final double reservedCartSpace = shouldShowCart
        ? (_isSearchFocused ? 150 : _minCartHeight)
        : 0;
            ...
            children: [
              SizedBox(
                height:
                    topPadding +
                    10 +
                    (reservedCartSpace > 0 ? reservedCartSpace + 10 : 0),
              ),
  ...
  void _createQuotation() {
    ...
    final total = _sharedCartItems!.fold(
      0.0,
  ...
  Widget _buildCartSection(double w, double currentHeight) {
    ...
    return GestureDetector(
      ...
      onDoubleTap: isSearchFocused
          ...
          : () {
              setState(
                () => _cartHeight = (_cartHeight < _maxCartHeight * 0.95)
                    ? _maxCartHeight
                    : _minCartHeight,
              );
            },
        ...
        child: Column(
          children: [
            Container(
              padding: EdgeInsets.symmetric(
                horizontal: R.sp(context, 16),
                vertical: isSearchFocused ? 6 : R.sp(context, 12),
              ),
              decoration: BoxDecoration(
                    ...
                    itemBuilder: (ctx, idx) {
                      ...
                      return GestureDetector(
                        ...
                        child: AnimatedContainer(
                          ...
                          padding: EdgeInsets.symmetric(
                            horizontal: isSearchFocused
                                ? 16
                                : R.sp(context, 16),
                            vertical: isSearchFocused ? 4 : R.sp(context, 8),
                          ),
                          decoration: BoxDecoration(
                            color: isHighlighted
