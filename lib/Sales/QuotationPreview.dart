...
class _QuotationPreviewPageState extends State<QuotationPreviewPage> {
              ...
              children: [
                pw.Text(
                  ...
                  style: pw.TextStyle(
                    ...
                    color: PdfColor.fromInt(0xFF2F7CF6),
                  ),
                ),
                ...
                pw.Divider(),
                pw.Text(
                  "Total Payable: ${widget.currencySymbol}${widget.total.toStringAsFixed(2)}",
                  style: pw.TextStyle(
                    fontWeight: pw.FontWeight.bold,
                    fontSize: 18,
                  ),
                          ...
                          Container(
                            ...
                            child: ListView.separated(
                              ...
                              itemBuilder: (c, i) => ListTile(
                                ...
                                trailing: Text(
                                  "${widget.currencySymbol}${widget.items[i].total.toStringAsFixed(2)}",
                                  style: const TextStyle(
                                    fontWeight: FontWeight.w700,
                                    fontSize: 13,
                                  ),
  ...
  Widget _summaryLine(String l, double v, {Color? color}) => Padding(
    ...
    child: Row(
      ...
      children: [
        ...
        Text(
          "${widget.currencySymbol}${v.toStringAsFixed(2)}",
          style: TextStyle(
            fontWeight: FontWeight.w700,
