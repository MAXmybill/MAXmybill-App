...
class _NewSalePageState extends State<NewSalePage> with SingleTickerProviderStateMixin {
  ...
  void _updateCartItems(List<CartItem> items) {
    ...
    String? triggerId;
    final previousItems = _sharedCartItems ?? const <CartItem>[];
    ...
    // Fallback to last item if we still don't know
    if (triggerId == null && updatedItems.isNotEmpty) {
      triggerId = updatedItems.last.productId;
    }
                  ...
                  return ListView.separated(
                    ...
                    itemBuilder: (ctx, idx) {
                      ...
                      return Material(
                        ...
                        child: InkWell(
                          onTap: () => _showEditCartItemDialog(originalIdx),
                          child: AnimatedContainer(
