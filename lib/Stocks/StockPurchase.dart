...
class _StockPurchasePageState extends State<StockPurchasePage> {
  ...
  void initState() {
    super.initState();
    _purchasesStreamFuture = FirestoreService().getCollectionStream(
      'stockPurchases',
    );
                  ...
                  InkWell(
                    onTap: () {
                      Navigator.push(
                        context,
                        CupertinoPageRoute(
                          builder: (_) => CreateStockPurchasePage(
                            uid: widget.uid,
                            onBack: () {
              ...
              child: FutureBuilder<Stream<QuerySnapshot>>(
                ...
                builder: (context, futureSnapshot) {
                  ...
                  if (!futureSnapshot.hasData)
                    return const Center(
                      child: Text("Unable to load purchases"),
                    );
  ...
  Widget _buildPurchaseCard(
    ...
    final creditAmount = (data['creditAmount'] ?? amount - paidAmount)
        .toDouble();
                      ...
                      children: [
                        if (creditAmount > 0)
                          Container(
                            ...
                            child: Text(
                              'Credit: $_currencySymbol${creditAmount.toStringAsFixed(0)}',
                              style: const TextStyle(
                                fontSize: 9,
                                fontWeight: FontWeight.w900,
                                color: kErrorColor,
  ...
  Widget _buildEmptyState() => Center(
    child: Column(
      ...
      children: [
        HeroIcon(HeroIcons.shoppingCart, size: 64, color: kGrey300),
...
class CreateStockPurchasePage extends StatefulWidget {
  ...
  @override
  State<CreateStockPurchasePage> createState() =>
      _CreateStockPurchasePageState();
}
...
class _CreateStockPurchasePageState extends State<CreateStockPurchasePage> {
  ...
  final _supplierNameController = TextEditingController(),
      ...
      _supplierGstinController = TextEditingController(),
  ...
  Future<void> _savePurchase() async {
    ...
    try {
      ...
      await FirestoreService().addDocument('stockPurchases', {
        ...
        'supplierGstin': _supplierGstinController.text.trim().isEmpty
            ? null
            : _supplierGstinController.text.trim(),
        'invoiceNumber': inv,
        'totalAmount': amt,
        'paidAmount': paid,
        'creditAmount': credit,
      ...
      if (_paymentMode == 'Credit' && credit > 0) {
        final cn =
            await NumberGeneratorService.generatePurchaseCreditNoteNumber();
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: _creditAmount > 0
                            ...
                            : kGoogleGreen.withValues(alpha: 0.1),
                        borderRadius: BorderRadius.circular(12),
                        border: Border.all(
                          color: _creditAmount > 0
                              ? Colors.orange
  ...
  Widget _buildSupplierAutocomplete() {
    return Autocomplete<Map<String, dynamic>>(
      optionsBuilder: (v) => v.text.isEmpty
          ? _vendors
          : _vendors.where(
              (ven) => ven['name'].toString().toLowerCase().contains(
                v.text.toLowerCase(),
              ),
            ),
      ...
      fieldViewBuilder: (ctx, ctrl, focus, onSub) {
        if (_supplierNameController.text.isNotEmpty && ctrl.text.isEmpty)
          ctrl.text = _supplierNameController.text;
  ...
  Widget _buildDateSelector() => GestureDetector(
    ...
    child: Container(
      ...
      child: Row(
        children: [
          const HeroIcon(HeroIcons.calendar, size: 16, color: kPrimaryColor),
...
class StockPurchaseDetailsPage extends StatelessWidget {
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (purchaseData['supplierGstin'] != null &&
                        purchaseData['supplierGstin'].toString().isNotEmpty)
                      _buildRow(
                    ...
                    if (purchaseData['taxAmount'] != null) ...[
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            '$currencySymbol${purchaseData['taxAmount']}',
                            style: const TextStyle(
                              fontSize: 11,
                              fontWeight: FontWeight.w700,
                              color: kBlack87,
  ...
  Widget _buildRow(HeroIcons i, String l, String v) => Padding(
    padding: const EdgeInsets.only(bottom: 10),
    child: Row(
      children: [
        HeroIcon(i, size: 14, color: kGrey400),
        const SizedBox(width: 10),
        Text(
          '$l: ',
          style: const TextStyle(
