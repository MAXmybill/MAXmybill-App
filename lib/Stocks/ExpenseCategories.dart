...
class _ExpenseCategoriesPageState extends State<ExpenseCategoriesPage>
  ...
  void initState() {
    ...
    _categoriesStreamFuture = FirestoreService().getCollectionStream(
      'expenseCategories',
    );
    _expenseNamesStreamFuture = FirestoreService().getCollectionStream(
      'expenseNames',
    );
  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      child: Scaffold(
        ...
        body: TabBarView(
          controller: _tabController,
          children: [_buildCategoriesTab(), _buildExpenseNamesTab()],
        ),
      ),
    );
  }
        ...
        Expanded(
          child: FutureBuilder<Stream<QuerySnapshot>>(
            ...
            builder: (context, futureSnapshot) {
              ...
              if (!futureSnapshot.hasData)
                return const Center(
                  child: Text("Unable to load expense names"),
                );
              ...
              return StreamBuilder<QuerySnapshot>(
                ...
                builder: (context, snapshot) {
                  ...
                  return ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      final data =
                          expenseNames[index].data() as Map<String, dynamic>;
                        ...
                        child: Material(
                          ...
                          child: InkWell(
                            ...
                            onTap: () => Navigator.push(
                              context,
                              CupertinoPageRoute(
                                builder: (_) => ExpenseNameDetailsPage(
                                  docId: expenseNames[index].id,
                                  name: name,
                                  usageCount: usageCount is int
                                      ? usageCount
                                      : int.tryParse(usageCount.toString()) ??
                                            0,
                                ),
                              ),
                            ).then((_) => setState(() {})),
  ...
  Widget _buildEmptyStateExpenseNames() => Center(
    child: Column(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        HeroIcon(HeroIcons.documentText, size: 64, color: kGrey300),
  ...
  Widget _buildEmptyState() => Center(
    child: Column(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        HeroIcon(HeroIcons.tag, size: 64, color: kGrey300),
        const SizedBox(height: 16),
        const Text(
          'No categories found',
          style: TextStyle(
                    ...
                    Wrap(
                      ...
                      children: suggestions.map((s) {
                        ...
                        return GestureDetector(
                          onTap: () =>
                              setDialogState(() => nameController.text = s),
                          child: AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                color: isSel ? kPrimaryColor : kGrey200,
                              ),
                            ),
                            child: Text(
                              s,
      ...
      builder: (context, val, child) {
        ...
        return Container(
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(12),
            border: Border.all(
              color: filled ? kPrimaryColor : kGrey200,
...
class _EditDeleteCategoryDialog extends StatefulWidget {
  ...
  const _EditDeleteCategoryDialog({
    required this.docId,
    required this.initialName,
    required this.onChanged,
  });
  @override
  State<_EditDeleteCategoryDialog> createState() =>
      _EditDeleteCategoryDialogState();
}
  ...
  Future<void> _delete() async {
    final confirm = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text('This will remove this category from the system.'),
        actions: [
          TextButton(
...
class _EditDeleteExpenseNameDialog extends StatefulWidget {
  ...
  final String initialName;
  final VoidCallback onChanged;
  const _EditDeleteExpenseNameDialog({
    required this.docId,
    required this.initialName,
    required this.onChanged,
  });
  @override
  State<_EditDeleteExpenseNameDialog> createState() =>
      _EditDeleteExpenseNameDialogState();
}

class _EditDeleteExpenseNameDialogState
    extends State<_EditDeleteExpenseNameDialog> {
  late TextEditingController _controller;
  @override
  void initState() {
    super.initState();
...
class _ExpenseNameDetailsPageState extends State<ExpenseNameDetailsPage> {
  ...
  Future<void> _loadExpenses() async {
    ...
    try {
      ...
      final snap = await col
          .where('expenseName', isEqualTo: _name)
  ...
  @override
  Widget build(BuildContext context) {
    final totalAmount = _expenses.fold(
      0.0,
          ...
          children: [
            ...
            if (_isLoading)
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      const Text(
                        'No expenses found under this name',
                        style: TextStyle(
                          color: kBlack54,
                          fontWeight: FontWeight.w600,
                        ),
              ...
              ...List.generate(_expenses.length, (i) {
                ...
                final refNumber =
                    (e['referenceNumber'] ?? e['expenseNumber'] ?? '')
                        .toString();
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  const SizedBox(width: 5),
                                  Text(
                                    refNumber.isNotEmpty ? refNumber : 'No Ref',
                                    style: const TextStyle(
                                      fontWeight: FontWeight.w900,
                                      color: kPrimaryColor,
                                      fontSize: 13,
